...
const clipboardSymbol = `<svg aria-hidden="true" viewBox="0 0 24 24" focusable="false"><path d="M9 3h6a2 2 0 0 1 2 2h1a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h1a2 2 0 0 1 2-2Zm0 2v2h6V5H9Zm-3 2v12h12V7h-1a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2H6Z"/></svg>`;
...
export class StateView extends View {
    protected override get content(): string {
        return `
            ...
            <p id="state-text">...</p>
            <button id="copy-error-button" class="copy-error-button" type="button" onclick="copyPreviousError()" title="Copy error message" aria-label="Copy error message" style="display: none;">${clipboardSymbol}</button>

            <form class="credential-container" id="credential-container" style="display: none;" onsubmit="submitCredentials(event)">
                <input id="credential-username" name="username" type="email" autocomplete="email" inputmode="email" autocapitalize="none" spellcheck="false" placeholder="Apple ID" required />
